...
const TeamSection = () => {
    return (
        <div className="rs-team team-style3 team-modify1 black-bg pt-120 pb-120 md-pt-80 md-pb-80">
            <div className="container">
                <div className="sec-title text-center mb-40 md-mb-25">
                    <span className="sub-text sub-text4">
                        Team Members
                    </span>
                    <h2 className="title title3 pb-27">
                        Meet with expert<span>enginners.</span>
                    </h2>
                </div>
